...
class Firebase {
  ...
  passwordReset = email => {
    console.log('Email Rest started', email);
    this.auth
      .sendPasswordResetEmail(email)
      .then(function () {
        console.log('Email Rest sent');
  ...
  generateProductKey = () => this.db.collection('products').doc().id;
